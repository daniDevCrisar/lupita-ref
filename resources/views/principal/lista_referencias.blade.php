                ...
                <table class="table table-bordered table-hover table-sm table-dark">
                    ...
                    @foreach($refs::$lista as $row)
                        <tr class="{{ $loop->odd ? 'table-secondary' : '' }}">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-info">{{$row->inicio_de_carga}} - {{$row->fin_de_carga}} </span></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success">{{$row->inicio_descargue}} - {{$row->fin_descargue}}</span></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <td style="font-size: 0.8rem;">
                            <i class="bi bi-buildings text-success"></i><i class="bi bi-arrow-right-short text-success"></i> {{ $row->origen_cliente_nombre }} (#{{$row->origen_cliente_id}})
                            <br><i class="bi bi-buildings text-danger"></i><i class="bi bi-arrow-left-short text-danger"></i> {{ $row->destino_cliente_nombre }} (#{{$row->destino_cliente_id}}) </td>
